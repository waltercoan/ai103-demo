...
def print_tool_outputs(response, turn_label: str) -> None:
	...
	for item in outputs:
		...
		if "tool" in item_type or "code_interpreter" in item_type:
...
def main() -> None:
	...
	# Define a tool code_interpreter para permitir execucao de codigo durante a resposta.
	tools = [{"type": "code_interpreter", "container": {"type": "auto"}}]

	# Primeira interacao usando Responses API com code_interpreter habilitado.
	prompt_1 = (
		"Use code_interpreter para calcular media e desvio padrao da lista "
		"[10, 12, 17, 19, 22]. Responda em portugues com 2 casas decimais."
	)
	print(f"\nUsuario (1): {prompt_1}")
	...
	prompt_2 = "Agora explique em uma frase curta o que o desvio padrao representa."
	print(f"\nUsuario (2): {prompt_2}")
